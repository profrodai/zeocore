# === QV-LLM:BEGIN ===
# path: quack-core/src/quack_core/core/fs/_operations/serialization_ops.py
# module: quack_core.core.fs._operations.serialization_ops
# role: module
...
class SerializationOperationsMixin:
    ...
    def _write_yaml(self, path: str | Path, data: dict[str, Any], atomic: bool = True) -> Path:
        ...
        return self._write_text(resolved, content, atomic=atomic)
