...
def create_service(
    ...
    Args:
        ...
        allow_absolute_paths: If True, allows operations outside the base_dir (unsafe).
    """
    return FileSystemService(base_dir=base_dir, log_level=log_level, allow_absolute_paths=allow_absolute_paths)