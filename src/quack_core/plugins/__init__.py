# === QV-LLM:BEGIN ===
# path: quack-core/src/quack_core/plugins/__init__.py
# module: quack_core.plugins.__init__
# role: module
...
# Discovery (listing available plugins without loading):
...
OLD (automatic):
    import quack_core.plugins  # Plugins auto-loaded
...
from quack_core.plugins.discovery import (
    LoadResult,
    PluginEntryPoint,
    PluginLoader,
