# === QV-LLM:BEGIN ===
# path: quack-core/src/quack_core/prompt/enhancer.py
# module: quack_core.prompt.enhancer
# role: module
# neighbors: __init__.py, plugin.py, registry.py, booster.py, strategy_base.py
# exports: enhance_with_llm, count_prompt_tokens
