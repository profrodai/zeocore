# === QV-LLM:BEGIN ===
# path: quack-core/src/quack_core/contracts/capability_models/demo/_impl.py
# module: quack_core.contracts.capability_models.demo._impl
# role: module
...
In a real system, capability implementations belong in Ring B (quack_core.capabilities).
...
from quack_core.contracts.capability_models.demo.models import EchoRequest, VideoRefRequest
