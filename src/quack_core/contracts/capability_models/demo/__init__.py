# === QV-LLM:BEGIN ===
# path: quack-core/src/quack_core/contracts/capability_models/demo/__init__.py
# module: quack_core.contracts.capability_models.demo.__init__
# role: module
...
"""
Demo capability_models for testing and examples.
