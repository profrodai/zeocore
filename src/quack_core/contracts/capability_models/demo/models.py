# === QV-LLM:BEGIN ===
# path: quack-core/src/quack_core/contracts/capability_models/demo/models.py
# module: quack_core.contracts.capability_models.demo.models
# role: models
...
# are OPTIONAL in contracts. They belong in Ring B (capabilities) if needed.
