# === QV-LLM:BEGIN ===
# path: quack-core/src/quack_core/contracts/capability_models/contract.py
# module: quack_core.contracts.capability_models.contract
# role: module
...
Instead of:
    from quack_core.contracts.capability_models.contract import CapabilityResult, ...
"""
