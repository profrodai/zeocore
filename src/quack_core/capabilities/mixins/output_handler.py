# === QV-LLM:BEGIN ===
# path: quack-core/src/quack_core/capabilities/mixins/output_handler.py
# module: quack_core.capabilities.mixins.output_handler
# role: module
...
class OutputFormatMixin:
    """
    Mixin that provides customization of output format for QuackTool modules.
