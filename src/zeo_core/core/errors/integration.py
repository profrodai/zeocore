...
class ZeoIntegrationError(ZeoError):
    """Base exception for all integration-related errors."""

    pass


class ZeoAuthenticationError(ZeoIntegrationError):
...
class ZeoApiError(ZeoIntegrationError):
...
class ZeoQuotaExceededError(ZeoApiError):
