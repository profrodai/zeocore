`zeo_core.core.fs` — Filesystem Architecture

**Status:** Canonical · Doctrine-Aligned
**Ring:** Core (ZeoCore)
**Audience:** Core maintainers, ZeoTool authors, junior contributors

---

## 1. Why this module exists

`zeo_core.core.fs` is the **filesystem kernel** of ZeoCore.

It defines **how all file IO happens across the ZeoVerse**, in a way that is:
...
## 2. Position in the ZeoVerse (Doctrine Alignment)
...
> If you see
> `from zeo_core.core.fs._internal import ...`
...
```python
from zeo_core.core.fs.service.standalone import read_text
```
...
> **If a ZeoTool, Agent, or Workflow touches `pathlib` directly — it is a bug.**
