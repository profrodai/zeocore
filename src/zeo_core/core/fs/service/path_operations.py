...
from zeo_core.core.fs.normalize import coerce_path_str, safe_path_str
from zeo_core.core.fs.protocols import FsPathLike
from zeo_core.core.fs.results import DataResult, ErrorInfo, PathResult
...
class PathOperationsMixin:
    ...
    def is_subdirectory(
        self, child: FsPathLike, parent: FsPathLike
    ) -> DataResult[bool]:
        try:
            ...
            return DataResult(
                ...
                meta={"input_child": s_child, "input_parent": s_parent}
                if (s_child or s_parent)
                else None,
            )
