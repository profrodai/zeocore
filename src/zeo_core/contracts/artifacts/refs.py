...
from zeo_core.contracts.common.ids import generate_artifact_id, is_valid_uuid
from zeo_core.contracts.common.time import utcnow
from zeo_core.contracts.common.typing import ArtifactRole
...
class ArtifactRef(BaseModel):
    ...
    This is the fundamental unit of data flow in ZeoCore. All artifacts
