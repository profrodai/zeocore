...
In a real system, capability implementations belong in Ring B (zeo_core.tools).

The underscore prefix (_impl.py) marks this module as internal/private.
Do not import these functions in production code.
"""

from zeo_core.contracts.capabilities.demo.models import EchoRequest, VideoRefRequest
from zeo_core.contracts.envelopes import CapabilityResult
