"""
ZeoCore Contracts - Canonical Data Contracts (Ring A / Kernel)

This module defines the stable, versionable contracts for the ZeoCore system.
...
from zeo_core.contracts.artifacts import (
    ArtifactRef,
    Checksum,
    ManifestInput,
    Provenance,
