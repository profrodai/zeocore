...
from zeo_core.integrations.pandoc.operations.utils import verify_pandoc
...
class PandocIntegration(BaseIntegrationService):
    ...
    def initialize(self) -> IntegrationResult:
        ...
        try:
            ...
            # Catch ALL exceptions here (ImportError, OSError, ZeoIntegrationError)
    ...
    def _build_conversion_tasks(
        ...
        from zeo_core.integrations.pandoc.operations import get_file_info
