...
are delegated to the zeo_core.core.fs service functions.
"""
...
from zeo_core.integrations.pandoc.protocols import (
...
class DocumentConverter(DocumentConverterProtocol, BatchConverterProtocol):
    ...
    def __init__(self, config: PandocConfig) -> None:
        ...
        Raises:
            ZeoIntegrationError: If Pandoc is not available.
        """
