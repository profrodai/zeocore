"""
Base classes for ZeoCore integrations.
...
from zeo_core.core.fs.normalize import coerce_path, coerce_path_str
...
class BaseConfigProvider(ABC, ConfigProviderProtocol):
    ...
    def _config_path_from_project_root_fallback(
        ...
        """
        Step 4 of _find_config_file: project_root/zeo_config.yaml fallback.
        Extracted for the same C901 reason as _config_path_from_env_var.
        """
        from zeo_core.core.fs.service import standalone

        if project_root:
            fallback = project_root / "zeo_config.yaml"
