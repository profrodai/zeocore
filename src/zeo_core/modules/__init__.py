...
This package provides a plugin system for ZeoCore, allowing
...
from zeo_core.modules import loader
...
OLD (automatic):
    import zeo_core.modules  # Plugins auto-loaded
...
from zeo_core.modules.discovery import (
    LoadResult,
    PluginEntryPoint,
    PluginLoader,
