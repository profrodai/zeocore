...
This module provides a registry for managing ZeoCore modules, using
...
class PluginRegistry:
    ...
    def __init__(self, log_level: int = LOG_LEVELS[LogLevel.INFO]) -> None:
        ...
        self._plugins: dict[str, ZeoPluginProtocol] = {}
    ...
    def unregister(self, plugin_id: str) -> None:
        ...
        Raises:
            ZeoPluginError: If plugin is not registered
        """
    ...
    def _unregister_by_type(self, plugin: ZeoPluginProtocol, plugin_id: str) -> None:
        """
    ...
    def execute_command(self, command: str, *args: object, **kwargs: object) -> object:
        ...
        Raises:
            ZeoPluginError: If the command is not found
        """
    ...
    def execute_workflow(
        ...
        Raises:
            ZeoPluginError: If the workflow is not found
        """
    ...
    def find_plugins_by_capability(self, capability: str) -> list[ZeoPluginProtocol]:
        """
    ...
    def get_plugin_module_path(self, plugin: ZeoPluginProtocol) -> str | None:
        """
    ...
    def reload_plugin(self, plugin_id: str) -> ZeoPluginProtocol:
        """
        ...
        Raises:
            ZeoPluginError: If the plugin is not registered or cannot be reloaded
        """
        from zeo_core.modules.discovery import loader
