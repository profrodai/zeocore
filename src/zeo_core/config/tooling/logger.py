...
def setup_tool_logging(
    ...
    """
    Set up logging for a ZeoTool with explicit paths.
...
def get_logger(tool_name: str) -> logging.Logger:
    ...
    """
    from zeo_core.core.logging import get_logger as core_get_logger
...
def log_teaching(logger: logging.Logger, message: str, level: str = "INFO") -> None:
    ...
    from zeo_core.core.logging.config import log_teaching as core_log_teaching
