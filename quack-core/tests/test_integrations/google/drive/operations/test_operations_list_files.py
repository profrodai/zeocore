# === QV-LLM:BEGIN ===
# path: quack-core/tests/test_integrations/google/drive/operations/test_operations_list_files.py  # noqa: E501
# === QV-LLM:END ===
...
class TestDriveOperationsListFiles:
    """Tests for the Google Drive _ops list_files functions."""
