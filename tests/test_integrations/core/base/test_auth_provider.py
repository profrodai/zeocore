...
class TestBaseAuthProvider:
    ...
    def test_init(self, temp_dir: Path) -> None:
        ...
        with patch("quack-core.fs.service.standalone.resolve_path") as mock_resolve:
    ...
    def test_resolve_path(self) -> None:
        ...
        with patch("quack-core.fs.service.standalone.resolve_path") as mock_resolve:
            ...
            with patch(
                    "quack-core.fs.service.standalone.normalize_path") as mock_normalize:
    ...
    def test_ensure_credentials_directory(self, temp_dir: Path) -> None:
        ...
        with patch("quack-core.fs.service.standalone.resolve_path") as mock_resolve:
            ...
            with patch("quack-core.fs.service.standalone.split_path") as mock_split:
                ...
                with patch("quack-core.fs.service.standalone.join_path") as mock_join:
                    ...
                    with patch(
                            "quack-core.fs.service.standalone.create_directory") as mock_create:
