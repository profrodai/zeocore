...
class TestGmailAttachmentOperations:
    ...
    def test_process_message_parts(self, tmp_path) -> None:
        ...
        with patch(
            "quack-core.integrations.google.mail.operations.attachments.handle_attachment"
        ) as mock_handle:
    ...
    def test_handle_attachment(self) -> None:
        ...
        with (
            ...
            patch(
                "quack-core.integrations.google.mail.operations.attachments.clean_filename",
                side_effect=lambda x: x,
            ),
            patch(
                "quack-core.integrations.google.mail.operations.attachments.standalone"
            ) as mock_fs,
            patch(
                "quack-core.integrations.google.mail.operations.attachments.base64"
            ) as mock_base64,
    ...
    def test_handle_attachment_with_attachment_id(self) -> None:
        ...
        with (
            ...
            patch("pathlib.Path") as mock_path,
            patch(
                "quack-core.integrations.google.mail.operations.attachments.execute_api_request"
            ) as mock_execute,
        ):
    ...
    def test_handle_attachment_with_error(self) -> None:
        ...
        with (
            ...
            patch(
                "quack-core.integrations.google.mail.operations.attachments.base64.urlsafe_b64decode",
