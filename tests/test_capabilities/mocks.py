# === QV-LLM:BEGIN ===
# path: quack-core/tests/test_capabilities/mocks.py
# role: tests
...
"""
Mocks for testing the quack_core.capabilities module.

This module provides mock objects and helper functions for testing
the capabilities components without actually using the real implementations
