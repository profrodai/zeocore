# === QV-LLM:BEGIN ===
# path: quack-core/tests/test_capabilities/test_toolkit_integration.py
# role: tests
...
"""
Integration tests for the capabilities package as a whole.

These tests focus on how the capabilities components work together
...
def complete_tool(mock_upload_service: MockUploadService) -> CompleteTool:
    ...
    with patch('quack_core.config.tooling.logger.setup_tool_logging'), \
            patch('quack_core.capabilities.base.setup_tool_logging'), \
...
class TestToolkitIntegration:
    """Test the capabilities components working together."""
