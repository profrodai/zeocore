...
install-all: install ## Install zeocore with all optional integrations
	...
	uv pip install -e ".[gmail,notion,supabase,google,drive,calendar,pandoc,llms,github,bluesky,http,ffmpeg,jupytext,notebook,mcp,mcp-dev,runtime-host]" --python $(PYTHON)
